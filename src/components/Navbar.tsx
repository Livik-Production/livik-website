                ...
                <div className="grid grid-cols-5 gap-5">
                  {[
                    ...
                    <motion.div
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.1 + colIdx * 0.05, duration: 0.3 }}
                    ...
                    >
                      {columnCategories.map((category) => {
                        ...
                        return (
                          <div key={category}>
                            <span className="text-[15px] font-extrabold text-[#004e8c] uppercase">
                              {category}
                            </span>
      ...
      <AnimatePresence>
        {activeDropdown && !isMobileMenuOpen && (
          <motion.div
            ...
            className="hidden md:block fixed inset-0 w-full h-[100vh] bg-black/10 backdrop-blur-sm pointer-events-none"
            style={{ zIndex: -1 }}
          />
        )}
      </AnimatePresence>
