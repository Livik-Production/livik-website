...
import {
  ...
  realEstateTargets,
  realEstateActive,
} from "@/data/industries/realestate";
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
        <div>
          <h1 className="text-3xl md:text-5xl font-bold leading-tight text-white">
            Turn Property Interest Into Closed Deals
          </h1>
        </div>

        <div className="space-y-6 text-white text-base leading-relaxed">
          <p>Getting inquiries isn’t the problem—converting them is.</p>

          <p>
            We design and develop end-to-end real estate systems that connect
            your listings, customer interactions and sales processes. This
            ensures faster response times, better lead tracking and improved
            conversion rates.
          </p>

          <p>
            Whether you’re managing residential, commercial, or rental
            properties, we help you turn interest into transactions.
          </p>
        </div>
      </div>
    </section>
...
function RealEstateServicesSection() {
  return (
    <section className="py-20 px-4">
      <div className="text-center mb-14">
        ...
        <p className="mt-4 text-gray-600 max-w-4xl mx-auto">
          We build platforms that streamline operations, generate high-quality
          leads and accelerate property transactions.
        </p>
      </div>
...
function RealEstateBenefits() {
  const benefits = realEstateBenefits;
...
const reasons = realEstatePoints;

function RealEstateWhyChooseUs() {
  return (
    ...
    <section className="py-16 bg-slate-300/70">
      <div className="max-w-7xl mx-auto px-6">
        <h2 className="text-3xl md:text-5xl font-bold leading-tight mb-8 text-center">
          How We Build Real Estate Platforms
        </h2>
...
function WhoThisIsFor() {
  const targets = realEstateTargets;
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container-custom max-w-5xl mx-auto text-center px-6">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold mb-8 relative z-10 leading-tight">
              ...
              Solutions That Generate Qualified Leads, Streamline Operations,
              and Accelerate Sales
            </h1>
            <p className="text-base md:text-xl text-muted-foreground mt-4 leading-relaxed max-w-4xl mx-auto px-2">
              In real estate, delays, missed inquiries and poor visibility
              directly impact revenue. At Livik, we build real estate platforms
              and digital systems that help you capture more leads, manage
              properties efficiently and close deals faster. From property
              listings to CRM integration, we ensure your business runs
              smoothly, efficiently and profitably.
            </p>

            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto text-left">
              {[
                "Capture and manage high-quality property leads",
                "Improve property visibility across digital channels",
                "Streamline sales and customer workflows",
                "Build scalable platforms for growing real estate operations",
              ].map((point, i) => (
            ...
            <div className="mt-10 flex flex-wrap justify-center gap-6">
              <Button asChild size="lg" variant="hero">
                <Link href="/contact" className="flex items-center gap-2">
                  Start Your Real Estate Project <ArrowUpRight size={20} />
                </Link>
              </Button>
              {/* <Button asChild size="lg" variant="outline" className="border-gradient-hero text-gradient-hero">
                <Link href="/contact" className="flex items-center gap-2">
                  Get a Free Strategy Consultation <ArrowUpRight size={20} />
                </Link>
              </Button> */}
            </div>
          </motion.div>
      ...
      <section className="py-20 px-4 gradient-hero text-white text-center">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold leading-tight">
            Ready to Improve Your Real Estate Sales and Operations?
          </h2>
          <p className="text-xl opacity-90 mt-4 max-w-3xl mx-auto space-y-2">
            <span>
              If your current systems are missing leads or slowing down deals,
              it’s time to upgrade.
            </span>
            <br />
            <span>
              Let’s build a platform that helps you sell faster and manage
              better.
            </span>
          </p>
