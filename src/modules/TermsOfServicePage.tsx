  ...
  const sections = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>
            This website may include information, articles, reports and other materials provided by third parties. You acknowledge and agree that such content is neither created, reviewed, nor endorsed by Livik Software Solutions. The third-party materials available on this website are shared solely for general informational purposes and should not be considered as any form of recommendation, promotion, or endorsement of the respective content, products, or services.
          </p>
          <p>
            While Livik Software Solutions makes reasonable efforts to source information from reliable providers, we do not guarantee the accuracy, completeness, reliability, or timeliness of any third-party content displayed on the website. Users are advised to independently verify any information before relying on it.
          </p>
          <p>
            Accessing third-party content may direct you to external websites that are not controlled or maintained by Livik Software Solutions. Visiting such external websites is entirely at your own risk and discretion. You are responsible for taking appropriate precautions to safeguard your devices and data against viruses, malware, or any other harmful elements.
          </p>
          <p>
            The inclusion of any external links on this website does not imply any sponsorship, endorsement, affiliation, partnership, or authorization by Livik Software Solutions regarding the linked websites or the trademarks, logos, trade names, or copyrighted materials displayed on those platforms.
          </p>
        </div>
      ),
    },
    ...
    },
    {
      ...
      content: (
        <p>
          You agree not to use the website for any unlawful, prohibited, or unauthorized activities. Any actions that may harm, disrupt, or negatively affect the infrastructure of Livik Software Solutions are strictly prohibited. You must also not attempt to access any of our servers, systems, or confidential information without proper authorization.
        </p>
      ),
    },
  ];
