...
const capabilities = [
  {
    ...
    description:
      "Fast, installable web apps that work across devices and improve accessibility and performance.",
    icon: Smartphone,
  },
  {
    title: "Single Page Applications (SPAs)",
    description:
      "Smooth, dynamic applications with fast navigation and real-time updates.",
    icon: LayoutGrid,
  },
  {
    title: "Interactive Dashboards",
    description:
      "Data-driven interfaces that simplify complex workflows and improve decision-making.",
    icon: Database,
  },
  {
    title: "Component-Based UI Development",
    description:
      "Reusable UI systems that speed up development and ensure consistency across applications.",
    icon: Component,
  },
  {
    title: "Server-Side Rendering with Vue",
    description:
      "Improve load speed and deliver better performance for dynamic applications.",
    icon: Globe,
  },
  {
    title: "Enterprise-Grade Applications",
    description:
      "Scalable solutions designed to handle complex workflows, large datasets and growing user bases.",
    icon: ShieldCheck,
  },
];
...
const benefits = [
  {
    title: "Built for Simplicity & Flexibility",
    description:
      "We create applications that are easy to manage, extend and adapt as your business evolves.",
  },
  {
    title: "Performance-Focused Development",
    description:
      "Optimized rendering and efficient architecture ensure smooth and fast user experiences.",
  },
  {
    title: "Scalable Code Architecture",
    description:
      "Your application grows without becoming difficult to maintain or upgrade.",
  },
  {
    title: "Reliable Delivery & Support",
    description:
      "We ensure your application remains stable, secure and high-performing over time.",
  },
];
    ...
    <div className="min-h-screen bg-white">
            ...
            <div className="text-left">
              <ScrollReveal>
                ...
                <h1 className="heading-hero text-white mb-6">
                  Vue.js Development for Fast, Flexible and Scalable Web
                  Applications
                </h1>
                <p className="cl-hero__para text-lead text-gray-300 mb-8 max-w-2xl">
                  {"A complex or slow frontend drives users away—and impacts business performance."
                    .split(" ")
                    .map((word, i) => (
                      <span
                        key={i}
                  ...
                  <br />
                  <br />
                  {"At Livik, we build high-performance Vue.js applications that are fast, intuitive and easy to scale. Whether you’re developing a web platform, dashboard, or enterprise application, we ensure your frontend is efficient, maintainable and built for growth."
                    .split(" ")
                    .map((word, i) => (
                      <span
                        key={i + 100}
                ...
                <div className="space-y-4 mb-10">
                  {[
                    ...
                    "Flexible architecture for evolving features",
                    "Scalable applications built for long-term use",
            ...
            <div className="relative">
              <ScrollReveal direction="left">
                <div className="relative z-10 w-full max-w-xl mx-auto">
                  <Image
                    src="/vue.png"
                    alt="Vue Development Illustration"
                    width={800}
                    height={800}
      ...
      <section ref={overviewRef} className="hero-react px-4 md:px-8">
        <div className="container-custom max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Build Applications That Stay Fast as You Scale
          </h2>
          <div className="mt-8 space-y-6">
            ...
            >
              ...
              scalable applications that adapt to changing business needs
            ...
            >
              ...
              solutions that perform reliably in real-world environments.
            </p>
          </div>
        </div>
      </section>
