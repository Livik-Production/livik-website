...
const capabilities = [
  {
    ...
    description:
      "Build flexible CMS platforms using WordPress and Drupal for easy content management and scalability.",
  },
  {
    title: "E-Commerce Development",
    description:
      "Develop high-performing eCommerce platforms using WooCommerce and Magento to drive sales and handle high traffic.",
  },
  {
    title: "Custom Web Applications",
    description:
      "Create scalable web applications using Laravel and Symfony tailored to your business needs.",
  },
  {
    title: "API Development & Integrations",
    description:
      "Build secure APIs and integrate third-party services to streamline workflows and data exchange.",
  },
  {
    title: "Legacy System Modernization",
    description:
      "Upgrade and optimize existing PHP applications to improve performance and maintainability.",
  },
  {
    title: "Custom CMS Solutions",
    description:
      "Develop tailored CMS platforms designed around your specific workflows and requirements.",
  },
];
...
const benefits = [
  {
    ...
    description:
      "Build powerful applications without high development and infrastructure costs.",
  },
  {
    title: "Faster Time-to-Market",
    description:
      "Launch quickly with efficient development processes and proven frameworks.",
  },
  {
    title: "Reliable & Scalable Systems",
    description:
      "Applications are built to handle growth, traffic and evolving business needs.",
  },
  {
    title: "Strong Ecosystem & Flexibility",
    description:
      "Leverage a mature ecosystem of tools and frameworks for faster and stable development.",
  },
];
...
const Breadcrumb = () => (
  ...
  >
    ...
    <span className="be-hero__sep mx-2">›</span>
    <span className="be-hero__crumb-active">PHP</span>
  </nav>
);
...
export default function PHPPage() {
  ...
  const titleText =
    "PHP Development for Fast, Cost-Effective and Scalable Web Applications";
        ...
        <div className="w-full px-6 lg:px-16 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="be-hero__art">
                ...
                >
                  ...
                  <g transform="translate(240, 170)">
                    <defs>
                      ...
                      <mask id="php-blend-mask">
                        <circle cx="0" cy="0" r="210" fill="url(#php-fade)" />
                      </mask>
                    </defs>
                    {/* High-Tech PHP Hero Image with Seamless Blending */}
                    <image
                      href="/php-be.png"
                      x="-200"
                      y="-200"
                ...
                >
                  <div className="be-hero__code-bar">
                    ...
                    <span className="be-hero__code-name">web.php</span>
                  </div>
                  <div className="be-hero__code-body">
                    <div>
                      <span className="be-kw">&lt;?php</span>
                    </div>
                    <div>
                      <span className="be-kw">use</span> App\Http\Controllers;
                    </div>
                    <div className="mt-2">
                      <span className="be-id">Route</span>::
                      <span className="be-fn">get</span>(
                      <span className="be-str">'/'</span>,{" "}
                      <span className="be-kw">function</span> () &#123;
                    </div>
                    <div className="pl-4">
                      <span className="be-kw">return</span>{" "}
                      <span className="be-fn">view</span>(
                      <span className="be-str">'welcome'</span>);
                    </div>
                    <div>&#125;);</div>
                  </div>
                </div>
            ...
            <div className="text-center lg:text-right order-1 lg:order-2">
              ...
              >
                Not every project needs over-engineered, expensive solutions.
              </p>
              ...
              >
                At Livik, we use PHP to build reliable, high-performing web
                applications that are cost-effective, scalable and quick to
                launch. From CMS platforms to eCommerce systems, we help you
                build stable applications without unnecessary complexity.
              </p>
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-2xl">
                  {[
                    ...
                    "Strong ecosystem with proven frameworks",
                  ].map((point, i) => (
        ...
        <div className="container-custom max-w-4xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-lead text-muted-foreground mt-8">
              ...
              secure and easy to maintain. Whether you’re launching a platform
              or modernizing an existing system, we ensure your solution is
              stable, flexible and built for long-term use. No
              overengineering—just systems that get the job done reliably.
            </p>
          </ScrollReveal>
        </div>
      </section>
