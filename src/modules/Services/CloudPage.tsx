...
const capabilities = [
  {
    ...
    description:
      "Automated build, test and deployment pipelines. Faster and more reliable releases.",
    icon: Settings,
  },
  {
    title: "Infrastructure as Code (IaC)",
    description:
      "Automated infrastructure provisioning. Consistent environments across development and production.",
    icon: Server,
  },
  {
    title: "Cloud Infrastructure Setup",
    description:
      "AWS and Azure environment design. Secure networking and configuration.",
    icon: Cloud,
  },
  {
    title: "Monitoring & Observability",
    description:
      "Real-time monitoring and alerting. Performance tracking and optimization.",
    icon: Activity,
  },
  {
    title: "DevSecOps",
    description:
      "Secure pipelines with integrated security. Access control, encryption and compliance.",
    icon: Shield,
  },
  {
    title: "Database DevOps",
    description:
      "Automated database deployments. Schema version control. Backup and recovery automation.",
    icon: Database,
  },
];
...
const benefits = [
  {
    ...
    description:
      "Deploy updates quickly and consistently across all your production environments.",
  },
  {
    title: "Reduced Manual Effort",
    description:
      "Automate repetitive processes to significantly increase your team's total productivity.",
  },
  {
    title: "Improved System Reliability",
    description:
      "Minimize downtime and system errors through our robust and highly reliable automated monitoring systems.",
  },
  {
    title: "Scalable Infrastructure",
    description:
      "Support rapid growth without facing any critical operational or technical bottlenecks.",
  },
];
    ...
    >
      ...
      <div className="cl-hero__content flex flex-col items-center text-center">
        <ScrollReveal>
          ...
          >
            {"Cloud & DevOps That Speeds Up Delivery, Cuts Costs and Scales Effortlessly"
              .split(" ")
              .map((word, i) => (
                <span
                  key={i}
          ...
          >
            {"Manual processes slow down releases, increase errors and limit scalability."
              .split(" ")
              .map((word, i) => (
                <span
                  key={i}
...
export default function CloudPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section
        className={`cl-hero flex flex-col pt-10 pb-10 px-4 md:px-8 bg-[#051121] ${isVisible ? "is-visible" : ""}`}
      >
        <div className="container-custom">
          ...
          >
            <p className="cl-hero__para text-gray-400 text-lg md:text-xl leading-relaxed mb-12 mx-auto text-center">
              {"At Livik, we implement DevOps and cloud automation solutions that help you accelerate delivery, improve system reliability and manage infrastructure efficiently."
                .split(" ")
                .map((word, i) => (
                  <span
                    key={i}
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              {[
                ...
                "Real-time monitoring and improved system reliability",
              ].map((badge, i) => (
                <div
                  key={i}
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button
                ...
                asChild
              >
                <Link href="/contact">Enable DevOps for Your Team</Link>
              </Button>
              {/* <Button
                size="lg"
                className="bg-white text-[#051121] hover:bg-gray-100 font-bold px-10 h-14 rounded-full transition-all active:scale-95"
                asChild
              >
                <Link href="/contact">Get a Free DevOps Assessment</Link>
              </Button> */}
            </div>
          </div>
        </div>
        ...
        <div className="container-custom max-w-4xl mx-auto text-center">
          <ScrollReveal>
            <h2 className="text-center text-2xl md:text-3xl lg:text-5xl font-bold leading-tight">
              From Manual Workflows to Continuous Delivery
            </h2>
            <p className="text-lead text-muted-foreground mt-8 text-justify">
              DevOps is how modern teams build, deploy and scale efficiently. We
              help you transition from manual processes to automated, reliable
              pipelines that improve speed, reduce risk and support continuous
              delivery.
            </p>
          </ScrollReveal>
        </div>
        ...
        <div className="container-custom text-center">
          <ScrollReveal>
            ...
            <p className="text-xl text-justify opacity-90 mb-8 max-w-2xl mx-auto mt-4 text-blue-50">
              If your deployments are slow or error-prone, it’s time to
              modernize.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6 mt-3">
              <Button
                size="lg"
                variant="secondary"
